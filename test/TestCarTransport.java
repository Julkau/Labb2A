...
public class TestCarTransport {
    ...
    public void carTransport_load_and_unload_cars() {
        CarTransport carTran = new CarTransport(2,100, Color.white,"Test.CarTransport", "123abc", 2, 0, 0);
        Saab95 saab95 = new Saab95("GYU438", 0, 0);
        Volvo240 volvo240 = new Volvo240("JZK991", 0, 0);
        carTran.lowerRamp();
    ...
    public void carTransport_should_throw_exception_when_loading_car_if_ramp_is_raised() {
        CarTransport carTran = new CarTransport(2,100, Color.white,"Test.CarTransport", "123abc", 4, 0, 0);
        Saab95 saab95 = new Saab95("GYU438", 0, 0);
        carTran.raiseRamp();
    ...
    public void carTransport_should_only_load_cars_that_are_relatively_close(){
        CarTransport carTran = new CarTransport(2,100, Color.white,"Test.CarTransport", "123abc", 4, 0, 0);
        Saab95 saab952 = new Saab95("GYI438", 0, 0);
    ...
    public void carTransport_cant_load_itself(){
        CarTransport carTran = new CarTransport(2,100, Color.white,"Test.CarTransport", "123abc", 1, 0, 0);
        assertThrows(UnsupportedOperationException.class, () -> carTran.loadCar(carTran));
    }
}
